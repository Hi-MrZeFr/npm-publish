...
`
  ...
  // 用到的库
  const LIBS = [
    'https://npm.elemecdn.com/hexo-mrzefr-filebed@1.2.2/css/live2d/pio.css',
    'https://npm.elemecdn.com/hexo-mrzefr-filebed@1.1.5/js/live2d/js/TweenLite.js',
    'https://npm.elemecdn.com/hexo-mrzefr-filebed@1.1.5/js/live2d/js/live2dcubismcore.min.js',
    'https://npm.elemecdn.com/hexo-mrzefr-filebed@1.1.5/js/live2d/js/pixi.min.js',
    'https://npm.elemecdn.com/hexo-mrzefr-filebed@1.1.5/js/live2d/js/cubism4.min.js',
    'https://npm.elemecdn.com/hexo-mrzefr-filebed@1.1.5/js/live2d/js/pio_sdk4.js',
    'https://npm.elemecdn.com/hexo-mrzefr-filebed@1.1.5/js/live2d/js/pio.js'
  ]
...
//   hidden:false,
    content: {
      ...
      referer: "Hello!", // 存在访问来源时的欢迎文本
      welcome: ["Hello!"], // 未开启时间问好时的欢迎文本
...
//   夜间模式控件
  ...
  function onModelLoad(model) {
    ...
    if (modelNmae === "Diana") {
      ...
      // 入场动作及文案
      initConfig.content.skin[1] = ["我是MrZeFr呀~", "Hi,小伙伴们~", "有人在吗？"]
      ...
      initConfig.content.skin[1] = ["我是</s>吃货担当 向晚 AvA~", "怎么推流辣！", "AAAAAAAAAAvvvvAAA 向晚！"]
      playAction({
        motion: "Tap左眼",
        from: {
          "Part15": 1
